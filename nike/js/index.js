$(function () {
    ...
    $(window).resize(function () {
        ...
        if(winWidth <= 1024) {
            ...
            $('.main_menu').on({
                mouseenter : function () {
                    $('.sub.menu, .sub_bg').show();
                },
                mouseleave : function () {
                    $('.sub.menum, .sub_bg').hide();
                }
            });
        }
        if(winWidth <= 480) {
            $('.main_01 img').attr('src','images/M-01-mobile.png');
            $('.main_02 img').attr('src','images/M-02-mobile.png');
            $('.main_03 img').attr('src','images/M-03-mobile.png');
        }else {
            $('.main_01 img').attr('src','images/M-01.png');
            $('.main_02 img').attr('src','images/M-02.png');
            $('.main_03 img').attr('src','images/M-03.png');
        }
    });//resize 이벤트 종료
...
});//문서가 준비되면 함수 시작(document.redy)부분 종료